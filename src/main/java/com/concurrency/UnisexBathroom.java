...
/**
 * Bathroom can be used by either all males or all females
 * Maximum of 3 people can use it, block others
 *
 */
...
public class UnisexBathroom {
    ...
    void useBathroom(String name) throws InterruptedException {
        System.out.println("\n" + name + " using bathroom. " +
                "Current employees in bathroom = " + empsInBathroom + " at time " + System.currentTimeMillis());
    ...
    void femaleUseBathroom(String name) throws InterruptedException {
        ...
        synchronized (this) {
            ...
            // REMEMBER: wait should always be in a while loop and make the thread wait again
            // Spurious wake ups are a real thing and we want to ensure we keep waiting
