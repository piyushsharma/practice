...
/**
 * To make sure no fight breaks out in an Uber ride, we want that
 * either an Uber ride can have all democrats or republicans
 * or two Democrats and two Republicans.
...
public class Uber {
    ...
    public static void runTest() throws InterruptedException {
        ...
        final Uber uberSeatingProblem = new Uber();
